...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateCaptionQuery = "UPDATE suspenssion SET
    name = '$name',
    brand = '$brand',
    weight = '$weight',
    ...
    if (!empty($_FILES['new_images']['tmp_name'][0])) {
        ...
        $fetchImageQuery = "SELECT images FROM suspenssion WHERE id = '$imageId'";
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($oldImageFilenames as $oldImage) {
                unlink("../gallery/suspenssion/" . trim($oldImage));
            }
            ...
            foreach ($_FILES['new_images']['tmp_name'] as $key => $tmp_name) {
                ...
                move_uploaded_file($_FILES['new_images']['tmp_name'][$key], "../gallery/suspenssion/" . $newfilename1);
            ...
            $updateImageQuery = "UPDATE suspenssion SET images = '$newImageFilenames' WHERE id = '$imageId'";
