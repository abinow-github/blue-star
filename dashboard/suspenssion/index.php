...
<div class="contents" style="margin-top: 100px;">
    <div class="side-menu" style="position: fixed;">
        <ul>
            ...
            <li class="active"><a href="../suspenssion"><img src="../../assets/img/icons/dropdown/suspension.png" alt="">Suspension</a></li>
    ...
    <div class="container-fluid" style="background-color: #336db6;color:white;padding:10px"><h4> Add suspension</h4></div>
