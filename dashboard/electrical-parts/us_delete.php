...
$fetchImageQuery = "SELECT images FROM electrical_parts WHERE id = '$id'";
...
if ($result->num_rows > 0) {
    ...
    foreach ($imageFilenames as $filename) {
        unlink("../gallery/electrical_parts/" . trim($filename));
    }

    // Delete the record from the database
    $deleteQuery = "DELETE FROM electrical_parts WHERE id = '$id'";
