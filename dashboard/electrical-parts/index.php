...
<div class="contents" style="margin-top: 100px;">
    <div class="side-menu" style="position: fixed;">
        <ul>
            ...
            <li class="active"><a href=""><img src="../../assets/img/icons/dropdown/electrical-parts.png" alt="">Electrical Parts</a></li>
    ...
    <div class="container-fluid" style="background-color: #336db6;color:white;padding:10px"><h4> Add electrical parts</h4></div>
