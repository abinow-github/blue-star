...
<div class="contents" style="margin-top: 100px;">
    <div class="side-menu" style="position: fixed;">
        <ul>
            ...
            <li class="active"><a href="../ac-parts"><img src="../../assets/img/icons/dropdown/ac-parts.png" alt="">A/C Parts</a></li>
            <li><a href="../other-parts"><img src="../../assets/img/icons/dropdown/other-parts.png" alt="">Other Parts</a></li>
        </ul>
    </div>
    <div class="content" style="margin-left: 200px;">
    <div class="container-fluid" style="background-color: #336db6;color:white;padding:10px"><h4> Add A/C Parts</h4></div>
