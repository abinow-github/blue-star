...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateCaptionQuery = "UPDATE other_parts SET
    name = '$name',
    brand = '$brand',
    weight = '$weight',
    ...
    if (!empty($_FILES['new_images']['tmp_name'][0])) {
        ...
        $fetchImageQuery = "SELECT images FROM other_parts WHERE id = '$imageId'";
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($oldImageFilenames as $oldImage) {
                unlink("../gallery/other_parts/" . trim($oldImage));
            }
            ...
            foreach ($_FILES['new_images']['tmp_name'] as $key => $tmp_name) {
                ...
                move_uploaded_file($_FILES['new_images']['tmp_name'][$key], "../gallery/other_parts/" . $newfilename1);
            ...
            $updateImageQuery = "UPDATE other_parts SET images = '$newImageFilenames' WHERE id = '$imageId'";
