...
$fetchImageQuery = "SELECT images FROM marine_spare_parts WHERE id = '$id'";
...
if ($result->num_rows > 0) {
    ...
    foreach ($imageFilenames as $filename) {
        unlink("../gallery/marine_spare_parts/" . trim($filename));
    }

    // Delete the record from the database
    $deleteQuery = "DELETE FROM marine_spare_parts WHERE id = '$id'";
