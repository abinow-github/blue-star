...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateCaptionQuery = "UPDATE marine_spare_parts SET
    name = '$name',
    brand = '$brand',
    weight = '$weight',
    ...
    if (!empty($_FILES['new_images']['tmp_name'][0])) {
        ...
        $fetchImageQuery = "SELECT images FROM marine_spare_parts WHERE id = '$imageId'";
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($oldImageFilenames as $oldImage) {
                unlink("../gallery/marine_spare_parts/" . trim($oldImage));
            }
            ...
            foreach ($_FILES['new_images']['tmp_name'] as $key => $tmp_name) {
                ...
                move_uploaded_file($_FILES['new_images']['tmp_name'][$key], "../gallery/marine_spare_parts/" . $newfilename1);
            ...
            $updateImageQuery = "UPDATE marine_spare_parts SET images = '$newImageFilenames' WHERE id = '$imageId'";
