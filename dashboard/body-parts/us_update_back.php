...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateCaptionQuery = "UPDATE body_parts SET
    name = '$name',
    brand = '$brand',
    weight = '$weight',
    ...
    if (!empty($_FILES['new_images']['tmp_name'][0])) {
        ...
        $fetchImageQuery = "SELECT images FROM body_parts WHERE id = '$imageId'";
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($oldImageFilenames as $oldImage) {
                unlink("../gallery/body_parts/" . trim($oldImage));
            }
            ...
            foreach ($_FILES['new_images']['tmp_name'] as $key => $tmp_name) {
                ...
                move_uploaded_file($_FILES['new_images']['tmp_name'][$key], "../gallery/body_parts/" . $newfilename1);
            ...
            $updateImageQuery = "UPDATE body_parts SET images = '$newImageFilenames' WHERE id = '$imageId'";
