...
<div class="contents" style="margin-top: 100px;">
    <div class="side-menu" style="position: fixed;">
        <ul>
            ...
            <li class="active"><a href=""><img src="../../assets/img/icons/dropdown/body-parts.png" alt="">Body Parts</a></li>
    ...
    <div class="container-fluid" style="background-color: #336db6;color:white;padding:10px"><h4> Add body parts</h4></div>
