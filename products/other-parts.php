...
<body>
 ...
 <div class="banner">
    <div class="container">
        <a class="pos-abs-title"> Other parts </a>
    </div>
 </div>
 <!-- banner END-->
...
$query = $mysqli->prepare('SELECT * FROM `other_parts`');
$query->execute();
...
for (; $row = $query_result->fetch_assoc(); ) {
    ...
    <div class="col-lg-3 col-md-4 col-6">
        <div class="card" onclick="window.location.href='other-parts/<?php echo $row['url'] ?>'">
            <div class="img-div">
                <img src="../dashboard/gallery/other_parts/<?php echo $row['images']; ?>" alt="" srcset="">
            </div>
            <div class="card-body">
