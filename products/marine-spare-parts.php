...
<body>
 ...
 <div class="banner">
    <div class="container">
        <a class="pos-abs-title"> Marine spare parts </a>
    </div>
 </div>
 <!-- banner END-->
...
$query = $mysqli->prepare('SELECT * FROM `marine_spare_parts`');
$query->execute();
$query_result = $query->get_result();
$nextUrls = array();
for (; $row = $query_result->fetch_assoc(); ) {
    $table = 'marine_spare_parts';
    $_SESSION['table'] = $table;
    ?>
    <div class="col-lg-3 col-md-4 col-6">
        <div class="card" onclick="window.location.href='marine-spare-parts/<?php echo $row['url'] ?>'">
            <div class="img-div">
                <img src="../dashboard/gallery/marine_spare_parts/<?php echo $row['images']; ?>" alt="" srcset="">
            </div>
            <div class="card-body">
