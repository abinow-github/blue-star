...
<body>
 ...
 <div class="banner">
    <div class="container">
        <a class="pos-abs-title"> body parts </a>
    </div>
 </div>
 <!-- banner END-->
...
$query = $mysqli->prepare('SELECT * FROM `body_parts`');
$query->execute();
...
for (; $row = $query_result->fetch_assoc(); ) {
    ...
    <div class="col-lg-3 col-md-4 col-6">
        <div class="card" onclick="window.location.href='body-parts/<?php echo $row['url'] ?>'">
            <div class="img-div">
                <img src="../dashboard/gallery/body_parts/<?php echo $row['images']; ?>" alt="" srcset="">
            </div>
            <div class="card-body">
